...
import com.example.mobileprogramming.course09.part02.LocationBasedServiceActivity;

import java.util.ArrayList;

public class Part02Activity extends AppCompatActivity {
    private final ArrayList<String> courseContentList = new ArrayList<>();
    private final String tag = "ACT/COURSE09-02";

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_course_09_02);
    ...
    private void initCourseContentList() {
        courseContentList.add("Location based Service");
    }

    private void initRecyclerView() {
        RecyclerView mRecyclerView = (RecyclerView) findViewById(R.id.course_09_02_recycler_view);
        ...
        mRecyclerViewAdpater.setOnItemClickListener(new CourseRecyclerViewAdapter.onItemClickListener() {
            ...
            public void onItemClick(View itemView, int itemPosition) {
                ...
                switch (itemPosition) {
                    case 0: // Location based Service
                        intent = new Intent(itemView.getContext(), LocationBasedServiceActivity.class);
                        break;
                    default:
