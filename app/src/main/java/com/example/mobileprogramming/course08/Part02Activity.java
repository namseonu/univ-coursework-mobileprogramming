...
import com.example.mobileprogramming.course08.part02.SQLiteActivity;
...
public class Part02Activity extends AppCompatActivity {
    ...
    private final String tag = "ACT/COURSE08-02";

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_course_08_02);
    ...
    private void initCourseContentList() {
        courseContentList.add("SQLite");
    }

    private void initRecyclerView() {
        RecyclerView mRecyclerView = (RecyclerView) findViewById(R.id.course_08_02_recycler_view);
        ...
        mRecyclerViewAdpater.setOnItemClickListener(new CourseRecyclerViewAdapter.onItemClickListener() {
            ...
            public void onItemClick(View itemView, int itemPosition) {
                ...
                switch (itemPosition) {
                    case 0: // SQLite
                        intent = new Intent(itemView.getContext(), SQLiteActivity.class);
                        break;
                    default:
